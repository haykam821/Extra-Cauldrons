...
public class Main implements ModInitializer {
	...
	public void registerModIntergationCauldrons() {
		...
		if (loader.isModLoaded("blockus")) {
			...
			registerCauldron("granite_brick", new Identifier("blockus", "granite_bricks"));
			registerLavaCauldron("lava_brick", new Identifier("blockus", "lava_bricks"));
			registerCauldron("water_brick", new Identifier("blockus", "water_bricks"));
			...
			registerCauldron("purpur_little_brick", new Identifier("blockus", "purpur_little_bricks"));
			registerCauldron("rainbow_brick", new Identifier("blockus", "rainbow_bricks"));
			registerLavaCauldron("obsidian_brick", new Identifier("blockus", "obsidian_bricks"));
			registerCauldron("quartz_tile", new Identifier("blockus", "quartz_bricks"));
			registerLavaCauldron("charred_nether_brick", new Identifier("blockus", "charred_nether_bricks"));
			...
			registerCauldron("limestone_brick", new Identifier("blockus", "limestone_bricks"));
			registerCauldron("marble", new Identifier("blockus", "marble"));
			registerCauldron("marble_brick", new Identifier("blockus", "marble_bricks"));
			registerCauldron("bluestone", new Identifier("blockus", "bluestone"));
			registerCauldron("bluestone_brick", new Identifier("blockus", "bluestone_bricks"));
			registerCauldron("bluestone_tile", new Identifier("blockus", "bluestone_tiles"));
			registerCauldron("bluestone_little_brick", new Identifier("blockus", "bluestone_little_bricks"));
